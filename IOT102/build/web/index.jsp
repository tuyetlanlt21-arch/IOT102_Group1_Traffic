                ...
                <div class="modal-body p-4 p-md-5">
                    ...
                    <form>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="email" class="form-control form-control-lg soft-input" id="loginEmail" placeholder="name@example.com" required>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="position-relative">
                                <input type="password" class="form-control form-control-lg soft-input pe-5" id="loginPassword" placeholder="Enter your password" required>
